...
This document defines the repository settings and maintainer conventions that are useful for `mivabyte/ui` without depending on plan- or visibility-specific GitHub enforcement features.

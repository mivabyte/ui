...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-popover text-popover-foreground p-6 shadow-overlay transition ease-[var(--motion-easing-out)] data-[state=closed]:duration-[var(--motion-duration-slow)] data-[state=open]:duration-[var(--motion-duration-slow)] data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {

...
>(({ className, ...props }, ref) => (
  <div
    className="ui-focus relative w-full overflow-auto"
    tabIndex={0}
    role="region"
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("bg-section [&_tr]:border-b", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-3 py-3 tabular-nums align-middle [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
      className
    )}
    {...props}
  />
